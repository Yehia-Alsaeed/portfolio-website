...
| Neon Free | PostgreSQL and Neon Auth | 100 CU-hours/project/month, 0.5 GB/project, 5 GB public transfer/month, scale-to-zero after 5 idle minutes, Managed Better Auth up to 60K MAU | Aggregate and expire raw analytics before 70% storage; keep queries indexed; keep admin auth to one account | https://neon.com/pricing and https://neon.com/docs/auth/overview |
