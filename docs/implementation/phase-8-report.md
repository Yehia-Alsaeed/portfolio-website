...
- The **11px label legibility** trade-off is still Yehia's design call; Production Best Practices reads 96 on `/projects` where that audit contributes, against a ≥90 target.
