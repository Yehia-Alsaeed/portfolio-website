...
- Adding a favicon - a pre-existing sitewide gap surfaced by this phase's Lighthouse check but predating it; `robots.txt` (the other gap found the same way) has since been added.
